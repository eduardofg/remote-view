...
(function() {
    ...
    window.Screen = function() {
        ...
        this.channel = 'totvs-remote-sharing';
        ...
        function initSignaler() {
            signaler = new Signaler(self, self.channel, self.info);
        }
    ...
    function Signaler(root, roomid, info) {
        var socket;
